...
const nextConfig = {
   ...
   */
  basePath: process.env.NODE_ENV === 'production' ? '/faucet' : '', // update if your repo name changes for 'npm run deploy' to work correctly
  assetPrefix: process.env.NODE_ENV === 'production' ? '/faucet/' : '', // update if your repo name changes for 'npm run deploy' to work correctly
};
